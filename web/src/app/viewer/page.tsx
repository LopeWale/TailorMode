        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <motion.button
              ...
              className="liquid-glass-secondary h-11 px-5 rounded-full font-medium text-[13px] inline-flex items-center gap-2 text-[#c4a77d] transition-all duration-200"
            >
            ...
            <motion.button
              whileTap={{ scale: 0.95 }}
              className="liquid-glass-primary h-11 px-5 rounded-full font-semibold text-[13px] inline-flex items-center gap-2 text-[#1a1816] transition-all duration-200"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>

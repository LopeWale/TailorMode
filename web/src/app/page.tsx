...
const nextSteps = [
  "Hook the measurement job queue into reconstruction workers for SMPL fitting and circumference extraction.",
  "Issue signed upload URLs per capture session so LiDAR payloads land in regional object storage.",
  "Render a Tailor dashboard list view fed by capture session and measurement job records for pilot ateliers.",
];
